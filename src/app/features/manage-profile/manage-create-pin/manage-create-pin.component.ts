...
@Component({
  selector: 'app-manage-create-pin',
  templateUrl: './manage-create-pin.component.html',
  styleUrls: ['./manage-create-pin.component.scss']
})
export class ManageCreatePinComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      this.formGroup = this._fb.group({
          ...
          ConfirmPin: ['', [Validators.required, Validators.minLength(4)]],
